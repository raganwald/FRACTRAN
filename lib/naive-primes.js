...
const primeSequence = (0, _naiveInterpreter.interpret)(syntax); // Any sufficiently complicated function that loops imperatively contains an ad hoc,
...
const somePrimes = (0, _generators.take)(5, compactExponentsOfTwo);
