...
exports.default = exports.pow = exports.log2 = exports.multiply = exports.divide = exports.decode = exports.encode = void 0;
...
const encode = n => {
  ...
  while (n > 1) {
    ...
    factorization.set(primeFactor, factorization.has(primeFactor) ? factorization.get(primeFactor) + 1 : 1);
    n = n / primeFactor;
  }
...
const decode = g => [...g.entries()].reduce((acc, _ref) => {
  let [factor, exponent] = _ref;
  return acc * Math.pow(factor, exponent);
}, 1); // find the least factor in n by trial division
