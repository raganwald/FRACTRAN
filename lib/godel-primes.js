...
var _godelMath = _interopRequireWildcard(require("./godel-math"));
...
const primeSequence = (0, _interpreter.default)({
  syntax,
  arithmetic: _godelMath.default
});
let primes = (0, _generators.compact)((0, _generators.mapWith)(_godelMath.log2, primeSequence));
