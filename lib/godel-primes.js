...
var _godelInterpreter = require("./godel-interpreter");
...
const primeSequence = (0, _godelInterpreter.interpret)(syntax);
let exponentsOfTwo = (0, _generators.compact)((0, _generators.mapWith)(_godel.exponentOfTwo, primeSequence));
